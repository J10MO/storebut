...
//   const deliveryCost = getTotalPrice() >= 50000 ? 0 : deliveryPrice
//   const totalWithDeliveryCost = getTotalPrice() + deliveryCost
...
//                       </div>
//                     </div>
//                     <p className="font-medium dark:text-white">{formatPrice(item.product.price * item.quantity)}</p>
//                   </div>
//                 ))}
...
//                   <div className="flex justify-between dark:text-gray-300">
//                     <span>تكلفة التوصيل</span>
//                     <span>{deliveryCost === 0 ? "مجاني" : formatPrice(deliveryCost)}</span>
//                   </div>
//                   <Separator className="dark:bg-gray-800" />
//                   <div className="flex justify-between font-bold text-lg dark:text-white">
//                     <span>الإجمالي</span>
//                     <span>{formatPrice(totalWithDeliveryCost)}</span>
//                   </div>
//                 </div>
...
const Checkout: React.FC = () => {
  ...
  const handleSubmitOrder = async () => {
    ...
    try {
      ...
      const orderData = {
        ...
        total_amount: getTotalPrice() + deliveryCost,
  ...
  const isDeliveryFree = deliveryCost === 0 || deliveryPrice === 1
            ...
            <Card className="dark:bg-gray-900/90 dark:border-gray-800">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between dark:text-gray-300">
                    <span>تكلفة التوصيل</span>
                    <span>{isDeliveryFree ? "مجاني" : formatPrice(deliveryCost)}</span>
                  </div>
                  <Separator className="dark:bg-gray-800" />
                  <div className="flex justify-between font-bold text-lg dark:text-white">
                    <span>الإجمالي</span>
