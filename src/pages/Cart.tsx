...
// //                               </p>
// //                               <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">
// //                                 {formatPrice(Number.parseFloat(item.product.price))} للواحد
// //                               </p>
// //                             </div>
// //                           </div>
// //                         </div>
...
// //                         </p>
// //                         <p className="text-xs text-amber-600 dark:text-amber-300 mt-1">
// //                           أضف {formatPrice(50000 - getTotalPrice())} للحصول على توصيل مجاني
// //                         </p>
// //                       </div>
// //                     </div>
// //                   </div>
...
//                     >
//                       {isDeliveryFree ? "مجاني 🎉" : formatPrice(shippingCost)}
//                     </span>
//                   </div>
//                 </div>
...
//                     <div>
//                       <p className="font-medium text-gray-900 dark:text-white text-sm sm:text-base">توصيل سريع</p>
//                       <p className="text-xs text-gray-600 dark:text-gray-300">لجميع المحافظات خلال 1-2 أيام</p>
//                     </div>
//                   </div>
...
const CartPage: React.FC = () => {
  ...
  // التوصيل مجاني فقط إذا كان سعر التوصيل = 1
  const isDeliveryFree = deliveryPrice === 1
  const shippingCost = isDeliveryFree ? 0 : deliveryPrice
  const totalWithShipping = getTotalPrice() + shippingCost
