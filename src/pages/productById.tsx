    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-700 text-lg font-medium">جاري تحميل المنتج...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="text-center bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full">
          ...
          <div className="flex gap-3 justify-center">
            <Button 
              onClick={() => navigate(-1)}
              variant="outline"
              className="border-2 border-gray-300 text-gray-700 hover:border-blue-500 hover:text-blue-600"
            >
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      <main className="container mx-auto px-4 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="bg-white rounded-2xl shadow-lg border-2 border-gray-200 overflow-hidden">
          ...
          <div className="space-y-6">
            <Card className="bg-white rounded-2xl shadow-lg border-2 border-gray-200">
              <CardHeader className="pb-4">
                <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 leading-tight text-right">
                  {product.name_ar || product.name}
                </h1>
              ...
              <CardContent className="space-y-6">
                ...
                {product.in_stock && (
                  <div className="space-y-3">
                    <p className="text-lg font-semibold text-gray-900">الكمية</p>
                ...
                <Button
                  ...
                  className="w-full h-14 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed"
                  size="lg"
                >
                  {addingToCart ? (
                    <>
