...
//                     </span>
//                   )}
//                   <span className="text-2xl font-bold text-green-1000 dark:text-green-500">
//                     {formatPrice(product.price)} د.ع
//                   </span>
//                 </div>
//                 {product.discount > 0 && product.original_price && (
...
//           {product.discount > 0 && (
//             <Badge className="bg-gradient-to-r from-red-500 to-pink-600 text-white text-[10px] px-2 py-1 rounded-full shadow-lg border-0 whitespace-nowrap">
//               {product.discount}%
//             </Badge>
//           )}
//         </div>
...
//             <Badge className="text-[10px] px-2 py-1 bg-gray-500/90 dark:bg-gray-700/90 text-white rounded-full shadow-md border-0 backdrop-blur-sm whitespace-nowrap">
//               غير متوفر
//             </Badge>
//           </div>
//         )}

//         <div className="relative h-40 sm:h-48 bg-gradient-to-br from-gray-50 dark:from-gray-800 to-gray-100 dark:to-gray-900 overflow-hidden flex-shrink-0 rounded-t-2xl">
//           {fullImageUrl && !imageError ? (
//             <>
//               {imageLoading && (
//                 <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-100 dark:from-gray-800 to-gray-200 dark:to-gray-900 z-10">
...
//             </>
//           ) : (
//             <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-gray-100 dark:from-gray-800 to-gray-200 dark:to-gray-900 p-3">
//               {product.emoji_icon ? (
//                 <span className="text-4xl sm:text-5xl transition-transform duration-300 group-hover:scale-110 mb-1">
//                   {product.emoji_icon}
//                 </span>
//               ) : (
//                 <Package className="w-12 h-12 sm:w-14 sm:h-14 text-gray-400 dark:text-gray-600 mb-1" />
//               )}
//               <span className="text-[10px] text-gray-500 dark:text-gray-400 text-center">
//                 {imageError ? "خطأ" : "لا توجد صورة"}
//               </span>
//             </div>
//           )}
...
//             <Button
//               size="sm"
//               className="h-7 text-[10px] px-2 bg-black/80 hover:bg-black dark:bg-white/90 dark:hover:bg-white text-white dark:text-black backdrop-blur-sm border-0 rounded-lg shadow-lg font-semibold"
//               onClick={(e) => {
//                 e.stopPropagation()
//                 handleViewDetails()
//               }}
...
//           <h3 className="font-bold text-sm line-clamp-2 text-gray-900 dark:text-gray-100 text-right leading-tight min-h-[2.5rem]">
//             {product.name_ar || product.name}
//           </h3>
//         </CardHeader>

//         <CardContent className="pb-2 px-3 space-y-2 flex-shrink-0">
//           <div className="flex items-center gap-1 justify-end">
//             <span className="text-[10px] text-gray-600 dark:text-gray-400">({product.reviews_count})</span>
...
//             </div>
//             {/* {product.discount > 0 && product.original_price && (
//               // <p className="text-[10px] text-red-600 dark:text-red-500 font-medium bg-red-50 dark:bg-red-900/20 px-2 py-1 rounded-full inline-block border border-red-100 dark:border-red-800/50">
//               //   وفر {formatPrice(calculateDiscount().toString())} د.ع
//               // </p>
//             )} */}
//           </div>
...
//               }}
//               disabled={!product.in_stock || isAddingToCart || isLoading}
//               className={`flex-1 h-9 text-xs transition-all duration-300 -ml-1 rounded-xl font-bold shadow-lg ${
//                 product.in_stock
...
//               }}
//               disabled={isFavoriteLoading}
//               className={`h-9 w-9 p-0 rounded-xl transition-all ml-2 duration-300 flex-shrink-0 ${
//                 isFavorite
//                   ? "bg-red-50 dark:bg-red-900/30 border-2 border-red-300 dark:border-red-700 hover:bg-red-100 dark:hover:bg-red-900/40"
//                   : "bg-gray-50 dark:bg-gray-800 border-2 border-gray-150 dark:border-gray-700 hover:bg-gray-200 dark:hover:bg-gray-700"
//               }`}
//             >
//               <Heart
...
//             <div className="flex items-center gap-1.5 justify-end">
//               {product.discount > 0 && product.original_price && (
//                 <span className="text-[13px] ml-0 mb-2 text-gray-400 dark:text-gray-500 line-through">
//                   {formatPrice(product.original_price)} د.ع
//                 </span>
//               )}
...
//               }}
//               disabled={!product.in_stock || isAddingToCart || isLoading}
//               className={`flex-1 h-9 text-xs transition-all duration-300 rounded-xl font-bold shadow-lg ${
//                 product.in_stock
//                   ? "bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white hover:shadow-xl hover:scale-[1.02]"
//                   : "bg-gray-200 text-gray-500 cursor-not-allowed hover:scale-100 dark:bg-gray-700 dark:text-gray-400"
//               }`}
...
//               }}
//               disabled={isFavoriteLoading}
//               className={`h-9 w-9 p-0 rounded-xl transition-all duration-300 flex-shrink-0 ${
//                 isFavorite
//                   ? "bg-red-50 dark:bg-red-900/30 border-2 border-red-300 dark:border-red-700 hover:bg-red-100 dark:hover:bg-red-900/40"
//                   : "bg-gray-50 dark:bg-gray-800 border-2 border-gray-100 dark:border-gray-750 hover:bg-gray-200 dark:hover:bg-gray-700"
//               }`}
//             >
//               <Heart
//                 className={`w-4 h-4 transition-all ${
...
const ProductCard: React.FC<ProductCardProps> = ({ product, variant = "vertical", isFavorite, onToggleFavorite }) => {
  ...
  const formatPrice = (price: string) => {
    const numberPrice = Number.parseInt(price)
    return numberPrice.toLocaleString('ar-IQ')
  }
        ...
        <CardFooter className="pt-2 px-3 pb-3 mt-auto flex-shrink-0">
          <div className="flex items-center gap-2 w-full">
            ...
            <Button
              ...
              disabled={!product.in_stock || isAddingToCart || isLoading}
              className={`flex-1 h-9 -ml-1 text-xs transition-all duration-300 rounded-xl font-bold shadow-lg ${
                product.in_stock
                  ? "bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white hover:shadow-xl hover:scale-[1.02]"
                  : "bg-gray-200 text-gray-500 cursor-not-allowed hover:scale-100 dark:bg-gray-700 dark:text-gray-400"
              }`}
            ...
            <Button
              ...
              className={`h-9 w-9 p-0  rounded-xl transition-all duration-300 flex-shrink-0 ${
                isFavorite
                  ? "bg-red-50 dark:bg-red-900/30 border-2 border-red-300 dark:border-red-700 hover:bg-red-100 dark:hover:bg-red-900/40"
                  : "bg-gray-50 dark:bg-gray-800 border-2 border-gray-100 dark:border-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700"
              }`}
            >
              <Heart
                className={`w-4 h-4 transition-all ${
