...
// // const ProductsList: React.FC<ProductsListProps> = ({ categoryId, searchQuery = "", viewMode = "grid" }) => {
// //   const { products, loading, error, refetch } = useProducts(categoryId && categoryId > 0 ? categoryId : undefined)
...
// //             <ProductCardSkeleton key={i} variant={viewMode === "list" ? "horizontal" : "vertical"} />
// //           ))}
// //         </div>
// //       </div>
// //     )
...
// //         </p>
// //         {searchQuery && filteredProducts.length === 0 && products.length > 0 && (
// //           <p className="text-sm text-gray-500 mt-1">جرب مصطلحات بحث أخرى أو امسح البحث لعرض جميع المنتجات</p>
// //         )}
// //       </div>
// //     </div>
// //   )
...
//     loadMore, 
//     isFetchingMore 
//   } = useProducts(categoryId && categoryId > 0 ? categoryId : undefined)
  ...
  return (
    <div className="py-6">
      ...
      <div className="text-center mt-8 pt-6 border-t border-gray-200">
        {/* <p className="text-sm text-gray-600">
          تم عرض {displayProducts.length} منتج
          {hasMore && ` (الصفحة ${currentPage} من ${totalPages})`}
        </p> */}
        {searchQuery && filteredProducts.length === 0 && products.length > 0 && (
          <p className="text-sm text-gray-500 mt-1">جرب مصطلحات بحث أخرى أو امسح البحث لعرض جميع المنتجات</p>
        )}
